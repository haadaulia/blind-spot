...
SYSTEM = (
    ...
    "• ENTAILED (verdict COVERED): a span of the target text, read on its own, "
    "describes the SAME risk — the same hazard AND the same mechanism — even if "
    "worded differently.\n"
    "• NOT ENTAILED (verdict ABSENT): the target text does not describe this "
    "specific risk. Sharing a TOPIC, a KEYWORD, or a general theme is NOT "
    "entailment. A span about a DIFFERENT risk that happens to share words is "
    "NOT entailment.\n"
    "• DEFAULT TO ABSENT. Only answer COVERED when a specific span clearly states "
    "this same risk. If your best span is merely related, answer ABSENT.\n"
    ...
    "(production-cost risk is a DIFFERENT risk from fuel-economy regulatory "
    ...
    "qualified employees.' → COVERED (same hazard, same mechanism).\n"
